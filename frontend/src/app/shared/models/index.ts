...
export interface PropertyFaqItem { question: string; answer: string; questionCs?: string; answerCs?: string; }
export interface PropertyMapMarker { title: string; category: string; description: string; latitude: number; longitude: number; }
export interface PropertyQuickContact { label: string; phone: string; }
export interface Property { id: string; hostId: string; name: string; address: string; wifiName: string; wifiPassword: string; airbnbReviewUrl: string; bookingReviewUrl: string; icalUrls: string[]; checkoutChecklist: string[]; faqList?: PropertyFaqItem[]; mapMarkers?: PropertyMapMarker[]; quickContacts?: PropertyQuickContact[]; customDomain?: string; }
...
export interface GuestRegistration { id: string; bookingId: string; propertyId: string; fullName: string; dateOfBirth: string; citizenship: string; documentNumber: string; documentType?: string; documentIssuingCountry?: string; documentExpiry?: string; gender?: string; address: string; createdAt: string; ubyportStatus?: 'PENDING'|'SUBMITTED'; }
export interface GuideItem { id: string; propertyId: string; title: string; titleCs?: string; slug: string; contentMarkdown: string; contentMarkdownCs?: string; videoUrl: string; qrCodeUrl: string; photoUrls: string[]; displayOrder: number; }
...
export interface PortalQrResponse { qrDataUrl: string; portalUrl: string; }
