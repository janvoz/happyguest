...
export interface GuideItem { id: string; propertyId: string; title: string; slug: string; contentMarkdown: string; contentMarkdownCs?: string; videoUrl: string; qrCodeUrl: string; photoUrls: string[]; displayOrder: number; }
