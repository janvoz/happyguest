...
public class NotificationService {
    ...
    public void sendPreArrivalEmails() {
        ...
        for (Booking booking : bookingRepository.findAllByIsRegistrationCompletedFalseAndPreArrivalSentFalse()) {
            if (booking.getCheckIn() != null && booking.getCheckIn().toLocalDate().isEqual(targetDate) && hasGuestEmail(booking)) {
                ...
                if (sendEmail(booking.getGuestEmail(), "Action Required: Complete Registration to Get Your Door Code", body)) {
