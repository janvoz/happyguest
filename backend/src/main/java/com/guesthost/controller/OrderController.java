...
public class OrderController {
    ...
    @PostMapping({"/api/guest/orders", "/api/public/guest/orders"})
    ...
    @GetMapping("/api/host/properties/{propertyId}/orders")
    public ResponseEntity<List<MinibarOrder>> getOrdersByProperty(Authentication authentication, @PathVariable String propertyId) {
