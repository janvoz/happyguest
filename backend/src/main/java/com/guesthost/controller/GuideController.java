...
public class GuideController {
    ...
    @GetMapping("/api/host/properties/{propertyId}/guides")
    public ResponseEntity<List<GuideItem>> getGuidesByProperty(Authentication authentication, @PathVariable String propertyId) {
